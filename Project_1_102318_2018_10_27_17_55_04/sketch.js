 ...
 */
    ...
    brushWater.brushStroke(random(60,132),random(78,118), random(122,187), random (150,220));
    brushWater.line1(60,90,141);
  //green points
    brushGrn = new Brush (random(1000), random(140,300));
    brushGrn.brushStroke(random (17,170),random(59,146), random(0,127), random (5,180));
  //purple lines
...
constructor(x_,y_){
  ...
  //rotate(random(3));
  ellipse (this.xBrush, this.yBrush,  random (5,20), random(20, 35));
  }  //brushstroke ends
  ...
  //draw some lines
  line1(r1,g1,b1){//line 1 = purple line
    
    stroke(r1,g1,b1);
    line (this.xBrush+random(4), this.yBrush,this.xBrush+random(4), this.yBrush+random(20,35));
